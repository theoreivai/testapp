package com.reivai.testapp.sunmiv1s;
...
import com.reivai.testapp.sunmiv1s.nfc.TableItem;
...
public class AidlUtil {
     ...
     * 打印二维码
     */
    public void printQr(String data, int modulesize, int errorlevel, int lineWrap) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
     ...
     * 打印文字
     */
    public void printBarCodeAhdi(String data, int symbology, int height, int width, int textposition, int lineWrap) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        try {
            woyouService.setAlignment(1, null); // alignment center
            woyouService.printBarCode(data, symbology, height, width, textposition, null);
            woyouService.lineWrap(lineWrap, null);
        } catch (RemoteException e) {
            e.printStackTrace();
    ...
    public void printTextBarcodeTitle(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
...
//            woyouService.lineWrap(1, null);
    ...
    public void printThanksText(String content, float size, boolean isBold, boolean isUnderLine, int lineWrap) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void printTitleText(String content, float size, boolean isBold, boolean isUnderLine, int alignment, int lineWrap) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void printSubTitleText(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
